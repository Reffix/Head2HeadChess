var path = require("path"),
  ...
  httpRoutes = require("./services/http"),
  socketRoutes = require("./services/socket"),
...
app.use(express.favicon(__dirname + "/resources/favicon.ico"));
...
io.set("authorization", function (handshakeData, callback) {
  cookieParser(handshakeData, {}, function (err) {
    ...
    sessionStore.load(
      handshakeData.signedCookies["connect.sid"],
